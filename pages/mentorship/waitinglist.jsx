...
const WaitingList = () => {
  ...
  const submitWaitingList = async (e) => {
    ...
    //   });
      ...
      //   response
      // );
      alertService.alertMethod("success", "Waiting list request sent successfully");
      setFormData({
        full_name: "",
        email: "",
      })
      ...
      <div className="contain">
        ...
        <div className="vector__purple-pyramid">
          ...
          <div className="waitinglist__feedback">
            <h2 className="center">Registration is <br></br>currently closed</h2>
            <p>Kindly join our waitlist</p>
            <div className="waitinglist__form">
            <WaitingListForm showLoader={showLoader} submitWaitingList={submitWaitingList} errors={errors} handleFormInputChange={handleFormInputChange} formData={formData} />
            </div>
