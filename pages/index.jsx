...
export default function Home({ indexPage }) {
  console.log(indexPage, "index page here!!!");
						...
						<div className='who-we-are--content'>
							...
							<div className='who-we-are--content-cta'>
								<Button
									...
									width={"243px"}
									handleClick={() =>
										window.open(indexPage.join_our_community_button_link, "_blank")
									}
									hasIcon>
				...
				<ul className='impact-list'>
					{indexPage.our_impact?.map((item, index) => (
						<li className='impact-item' key={item.title}>
							...
							<div className='text'>
								<div>
									<h1 className='section-title'>{(index < 9 ? "0" : "") + (index + 1)}</h1>
									<h3>{item.title}</h3>
				...
				<div className='call-for-sponsors--text'>
					<div>
						...
						<Button
							...
							handleClick={() => window.open(indexPage.become_a_sponsor_button_link, "_blank")}
						/>
					</div>
				</div>
			...
			<section className='mentorship' id='mentorship'>
				<div className='container'>
					...
					<Button
						...
						handleClick={() => window.open(indexPage.mentorship_button_link, "_blank")}
					/>
				...
				<div className='container'>
					...
					<div className='btn-container'>
						<Button
							...
							handleClick={() => window.open(indexPage.youtube_button_link, "_blank")}
						/>
					</div>
				</div>
			</section>
