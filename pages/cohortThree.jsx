    ...
    <>
      ...
      <div className="analytics">
          <ul className="analytics--container">
            <li className="analytics--border">
              <span className="analytics--text">Regsitration Opens</span>
              <h3>JUNE 20TH, 2022</h3>
            </li>
            <li className="analytics--border">
              <span className="analytics--text">Regsitration Closes</span>
              <h3>JUNE 20TH, 2022</h3>
            </li>
            <li className="analytics--without--border">
              <span className="analytics--text">Cohorts Starts</span>
              <h3>JUNE 20TH, 2022</h3>
            </li>
